			...
			<div class="col-md-3 mt-3">
				<div class="card p-3 crd-hover mt-2"
					...
					<div class="row m-auto">
						<a href="" class="btn btn-success btn-sm p-1 ml-5"
							style="margin-left: 28%;">View Details</a> <a href=""
							class="btn btn-danger btn-sm ml-3"><%=arb.getPrice()%>&nbsp;<i
				...
				<div class="row m-auto ">
					...
					<a href=""class="btn btn-danger btn-sm ml-1"><%=arb.getPrice()%>&nbsp;<i class="fas fa-rupee-sign"></i></a>
				</div>
				<%
				}
				%>
