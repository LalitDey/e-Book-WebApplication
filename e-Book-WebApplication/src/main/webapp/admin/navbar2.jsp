		...
		<div class="col-md-6 ">
			...
			<c:if test="${not empty userobj }">
				...
				<a data-toggle="modal" data-target="#exampleModalCenter"
					class="btn btn-primary text-white ml-5">Logout &nbsp;<i
...
<!-- LOGOUT PopUp Modal From bootstrap -->
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="text-center">
					<h4 class="text-danger">Do You Want to Delete ?</h4>
					<button type="button" class="btn btn-primary text-white" data-dismiss="modal">No</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<a href="../logout" type="button" class="btn btn-danger text-white">Ok</a>
				</div>
			</div>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-custom">
	<a class="navbar-brand" href="home.jsp"
		style="color: #0bff0b; font-weight: bold;">EBooks</a>
